...
| `ecosystem` | string | `npm`, `pypi`, `maven`, `nuget`, `cargo`, `go`, `packagist`, `pub`. Same closed-set caveat as `kind`: the receiver has to learn a new one before this tool emits it. |
